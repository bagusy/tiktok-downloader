...
title TikTok Quick (1-Click)
cd /d "%~dp0"

echo ============================================================
echo                  TikTok Quick (1-Click)
echo            Download + Upload otomatis 1 klik
echo ============================================================
echo.
...
REM ========== [3/3] Start server + buka browser ke /quick ==========
echo [3/3] Menjalankan server (mode QUICK)...
echo.
echo ============================================================
echo   Server: http://127.0.0.1:5000/quick
echo   Mode: 1-klik (download + upload otomatis)
...
REM Buka browser ke /quick
start "" /b cmd /c "ping -n 4 127.0.0.1 >nul && start """" http://127.0.0.1:5000/quick"
